#!/usr/bin/env python3
"""Validate the bundled GRE Glance word data and report actionable issues."""
...
DEFAULT_PATH = ROOT / "Shared" / "Resources" / "gre_words.json"
...
def validate(words: list[dict[str, Any]]) -> tuple[list[str], list[str]]:
    errors: list[str] = []
    warnings: list[str] = []
...
def main() -> int:
    ...
    errors, warnings = validate(words)
